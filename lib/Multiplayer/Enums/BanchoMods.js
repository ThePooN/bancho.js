...
const Enum = Object.freeze({
	...
	TouchDevice: new BanchoMod(4, "td", "TouchDevice"),
	...
	Autoplay: new BanchoMod(2048, "at", "Autoplay"),
	...
	Cinema: new BanchoMod(4194304, "cm", "Cinema"),
	Target: new BanchoMod(8388608, "tp", "Target"),
	Key9: new BanchoMod(16777216, "k9", "Key9"),
	KeyCoop: new BanchoMod(33554432, "co", "KeyCoop"),
	Key1: new BanchoMod(67108864, "k1", "Key1"),
	Key3: new BanchoMod(134217728, "k3", "Key3"),
	Key2: new BanchoMod(268435456, "k2", "Key2"),
	ScoreV2: new BanchoMod(536870912, "sv2", "ScoreV2"),
	Mirror: new BanchoMod(1073741824, "mr", "Mirror"),
});
